...
<body>
    ...
    def create_streamlit_response(self, response: OceanographicResponse) -> Dict[str, Any]:
        """Create a response format suitable for Streamlit frontend."""
        return {
            "status": response.status.value,
            "message": response.message,
            "query": response.query,
            "data": [section.content for section in response.data],
