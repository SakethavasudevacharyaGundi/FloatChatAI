...
from app.services.ai.llm_service import GeminiOrchestrator
...
class EnhancedRAGPipeline:
    ...
    def __init__(self, vector_store =None):
        ...
        self.gemini_processor = GeminiOrchestrator()
        self.context_limit = Config.CONTEXT_LIMIT
        
        logger.info("🧠 Enhanced RAG Pipeline with Gemini AI initialized")
    
    async def query(self, query: str, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self._generate_intelligent_response(query, processed_context, query_analysis)
    ...
    async def _analyze_query_intent(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            gemini_response = await self.gemini_processor.process_query(
    ...
    async def _generate_intelligent_response(self, query: str, context: Dict[str, Any], 
                                     query_analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Get Gemini response
            gemini_response = await self.gemini_processor.process_query(prompt)
