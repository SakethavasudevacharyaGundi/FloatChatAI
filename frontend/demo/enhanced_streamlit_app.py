...
#     from backend.app.services.rag.enhanced_rag_pipeline import EnhancedRAGPipeline
...
st.set_page_config(
    page_title="FloatChat IA",
    layout="wide"
)

st.title("🌊 FloatChat IA")
st.subheader("AI Ocean Intelligence Platform")
...
example_queries = [
    ...
    "Analyze salinity profiles",
    "Show oxygen concentration changes",
    "Compare chlorophyll levels",
...
if st.button("Analyze Ocean Data"):

    with st.spinner("🌊 Analyzing oceanographic patterns..."):
