...
class Canvas {
  ...
  update() {
    ...
    if (this.medias) {
      this.medias.forEach((media: any) => media.update(this.scroll));
    }
  ...
  addEventListeners() {
    ...
    // Listen on window for scroll wheel so it works everywhere on the page
...
export default function FlyingPosters({
  ...
  // Removed local canvas preventDefault wheel events so it scrolls natively
  // The Canvas class now listens to window wheel events.
